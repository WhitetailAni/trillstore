...
struct VideoPlayerView: View {
    ...
    HStack {
        ...
        .alert("idk what to put here", isPresented: $endShow) {
                Button("so this button is an infinite loop") {
                    endShow = true
                }
            }
...
struct VideoList: View {
    let videos = ["stw true end", "celeste", "farewell", "dr strangelove", "oceans eleven", "true facts about the mantis shrimp", "undertale concert", "try not to laugh #14", "deja vu", "divine beast, vah ruta", "divine beast, vah medoh", "divine beast, vah rudania", "mario bros opinions", "putin legend", "rat speeder", "spamton", "iphone massacre", "german", "hammerJB tutorial", "cool cat kids superhero", "unlimited power cables", "vector", "rocket knife"]
